...
- Système d’alerte automatique + visualisations interactives  

### 💬 ChatApp Light – Messagerie Temps Réel  
**Flutter | Firebase | Provider/Riverpod**  
...
### 🔹 Développeuse Full‑Stack / IA – ESTO Oujda  
YOLOv8 • OpenCV • Python  
- Détection et comptage d’objets en temps réel  
- Optimisation des pipelines d’images  

### 🔹 Développeuse Python – ENSAO  
- Application desktop pour gestion documentaire  
- Automatisation des processus administratifs  

### 🔹 Développeuse – SupMTI  
- Conception BD relationnelle (Access)  
- Analyse des besoins + requêtes SQL  
...
https://www.linkedin.com/in/ahlam-el-amrani/
